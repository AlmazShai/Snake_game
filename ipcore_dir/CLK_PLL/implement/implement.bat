...
xst -ifn xst.scr
move CLK_PLL_exdes.ngc results\

REM  Copy the constraints files generated by Coregen
echo 'Copying files from constraints directory to results directory'
copy ..\example_design\CLK_PLL_exdes.ucf results\

cd results

echo 'Running ngdbuild'
ngdbuild -uc CLK_PLL_exdes.ucf CLK_PLL_exdes

echo 'Running map'
map -timing -pr b CLK_PLL_exdes -o mapped.ncd
...
netgen -ofmt verilog -sim -sdf_anno false -tm CLK_PLL_exdes -w routed.ncd routed.v
cd ..
